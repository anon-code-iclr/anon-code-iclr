...
WORK_DIR=${PROJECT_DIR}/work_dirs/data/ctrg-brain-zh
REPORTS_PATH=path/to/ctrg_brain_zh_valid.json
VERSION=full
...
python ${PROJECT_DIR}/src/eval/ctrg_brain_filter_abnormal.py \
    --results_path ${WORK_DIR}/${VERSION}/results_raw.json \
    --results_abnormal_path ${WORK_DIR}/${VERSION}/results_raw_abnormal.json

python ${PROJECT_DIR}/src/eval/scoring.py \
    --results_path ${WORK_DIR}/${VERSION}/results_raw_abnormal.json \
    --scores_dir ${WORK_DIR}/${VERSION}/scores_raw_abnormal
...
python ${PROJECT_DIR}/src/eval/ctrg_brain_filter_abnormal.py \
    --results_path ${WORK_DIR}/${VERSION}/results_filtered_text.json \
    --results_abnormal_path ${WORK_DIR}/${VERSION}/results_filtered_text_abnormal.json

python ${PROJECT_DIR}/src/eval/scoring.py \
    --results_path ${WORK_DIR}/${VERSION}/results_filtered_text_abnormal.json \
    --scores_dir ${WORK_DIR}/${VERSION}/scores_filtered_text_abnormal
...
python ${PROJECT_DIR}/src/eval/ctrg_brain_filter_abnormal.py \
    --results_path ${WORK_DIR}/${VERSION}/results_filtered_insuff.json \
    --results_abnormal_path ${WORK_DIR}/${VERSION}/results_filtered_insuff_abnormal.json

python ${PROJECT_DIR}/src/eval/scoring.py \
    --results_path ${WORK_DIR}/${VERSION}/results_filtered_insuff_abnormal.json \
    --scores_dir ${WORK_DIR}/${VERSION}/scores_filtered_insuff_abnormal
