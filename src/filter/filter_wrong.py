...
args.add_argument("--filter_wrong_path", type=str, default=None)
args = args.parse_args()


def filter_wrong_units(json_path: str):
...
if __name__ == "__main__":
    unit_list = filter_wrong_units(args.results_path)

    os.makedirs(os.path.dirname(args.filter_wrong_path), exist_ok=True)
    with open(args.filter_wrong_path, "w", encoding="utf-8") as f:
